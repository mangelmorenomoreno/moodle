...
public class TokenGenerator {
  ...
  public static String createTokenMacro(TokenData tokenData) {
    ...
    return Jwts.builder().issuer(SecurityConstants.CARVAJAL)
             ...
             .claim(SecurityConstants.USERNAME,
               tokenData.getUsuario().getNombre() + " "
                 + tokenData.getUsuario().getApellido())
             .claim(SecurityConstants.EMAIL, tokenData.getUsuario()
                                               .getCorreoElectronico())
             .claim(SecurityConstants.IDUSER, tokenData.getUsuario().getUserId())
             .issuedAt(new Date())
  ...
  public static String createTokenMacroChangePassword(Usuario userMenu) {
    ...
    return Jwts.builder().issuer(SecurityConstants.CARVAJAL).subject(SecurityConstants.JWT_TOKEN)
             .claim(SecurityConstants.USERNAME, userToken.getNombre() + " "
                                                  + userToken.getApellido())
