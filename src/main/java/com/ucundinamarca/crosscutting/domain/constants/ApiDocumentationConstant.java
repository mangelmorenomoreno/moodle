...
public class ApiDocumentationConstant {
  ...
  public static final String USUARIO_PREGRADO_NOTES = "Consulta la informacion de los "
  ...
  public static final String USUARIO_PREGRADO_VALUE = "Informacion Usuario por matricular pregrado";
  ...
  public static final String USUARIO_PREGRADO_NICK = "Usuario por matricular en moodle";
